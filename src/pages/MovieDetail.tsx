...
import { Star, Play, Clock, Calendar, ArrowLeft, Plus, Check, Users } from 'lucide-react';
          ...
          >
            ...
            <div className="mb-8">
              ...
              <div className="flex flex-wrap gap-2 sm:gap-3 items-center justify-center md:justify-start">
                ...
                <AmazonAffiliateButton title={movie.title} year={movie.release_date?.substring(0, 4)} />
              </div>
