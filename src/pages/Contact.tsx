        ...
        <div className="grid md:grid-cols-5 gap-12">
          ...
          >
            <div className="bg-white/5 border border-white/10 rounded-2xl p-6">
              ...
              <p className="text-gray-400 font-sans text-sm">support@cinemadiscovery.com</p>
            </div>
            ...
            <div className="bg-white/5 border border-white/10 rounded-2xl p-6">
              ...
              <p className="text-gray-400 font-sans text-sm">@CinemaDiscovery on all platforms</p>
            </div>
